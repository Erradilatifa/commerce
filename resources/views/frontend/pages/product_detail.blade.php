									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
                                                ...
                                                @endphp
												<p class="price"><span class="discount">dh{{number_format($after_discount,2)}}</span><s>dh{{number_format($product_detail->price,2)}}</s> </p>
                                ...
                                <div class="single-product">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-price">
                                            ...
                                            @endphp
                                            <span class="old">dh{{number_format($data->price,2)}}</span>
